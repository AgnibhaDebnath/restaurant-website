    ...
    return (
        <section className=' font-[inter] pt-5 pb-16'>
            ...
            <div className='flex justify-center py-2  pb-5'>
                <h2 className='text-center text-xl'>Authentic flavors, crafted with tradition</h2>
            </div>
            <div className='w-full px-5 min-[600px]:px-10'>
                <div className='flex flex-col min-[906px]:flex-row  min-[906px]:justify-between items-center max-[906px]:gap-5'>
                    <div className='flex flex-col justify-center pl-0 min-[906px]:pl-5 min-[950px]:pl-10 pr-0 min-[906px]:pr-4 gap-2'>
                        <p className='text-lg min-[1100px]:text-xl max-w-2xl text-gray-600 leading-relaxed'>We bring the rich taste of Bengal to your plate with recipes passed down through generations.</p>

                        <p className='text-lg min-[1000px]:text-xl max-w-2xl text-gray-600 leading-relaxed'>Every dish is prepared using fresh ingredients, traditional spices, and a passion for authentic cooking.</p>
                        <ul className="mt-4 space-y-2 text-lg flex  gap-3 flex-col">
