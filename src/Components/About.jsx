...
const About = () => {
    return (
        <section id='about' className='font-[inter] pt-5 pb-16 scroll-m-17 bg-orange-50'>
            ...
            <div className='w-full pl-5 pr-4 min-[600px]:px-10'>
                <div className='flex flex-col min-[906px]:flex-row  min-[906px]:justify-between items-center max-[906px]:gap-5'>
                    <div className='flex flex-col justify-center  pl-0 min-[906px]:pl-5 min-[950px]:pl-10 pr-0 min-[906px]:pr-4 gap-2'>
                        ...
                        <ul className="mt-4 space-y-2 font-medium text-base min-[487px]:text-lg flex  gap-3 flex-col  text-gray-600 ml-1.5">
                    ...
                    <img src={About_section_image} className='w-76 min-[1100px]:w-100 h-55 min-[1100px]:h-70 object-cover rounded-4xl shadow-2xl  hover:scale-105 transition duration-200' alt="About section image" />
                </div>
            </div>
        </section>
    )
